...
<template>
    <header class="sticky top-0 z-10 flex w-full bg-white dark:bg-boxdark ">
        <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-23 md:px-6 2xl:px-11">
