...
<template>
    <li>
        <Link :href="item.route"
            class="group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-[#DEE4EE] !text-[14.975px] leading-[20.9625px] duration-300 ease-in-out hover:bg-slate-800 dark:hover:bg-meta-4"
